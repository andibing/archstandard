...
// the $id directly.
// `_headers` and `_redirects` are Cloudflare Pages config files — they only
...
// them silently.
const ROOT_KEEP = ['_redirects', '_headers', 'v2', 'robots.txt', 'og-image.png', 'og-image.svg', 'favicon.svg', 'schema', 'llms.txt', 'llms-full.txt'];
