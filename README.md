...
| What | Licence | File |
|------|---------|------|
| **Standard content** (MDX pages, templates, schema, examples, guidance) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | `LICENSE-CONTENT` |
| **Source code** (JavaScript, CSS, Astro config, build scripts) | [MIT](https://opensource.org/licenses/MIT) | `LICENSE-CODE` |
