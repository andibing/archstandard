...
description: "A completed SAD for a MediCore Trust patient portal on Microsoft Azure, demonstrating ADS at Comprehensive depth for a Tier 1 Critical clinical system."
---
...
| Operational support model and ITIL alignment | Tom Doe | 5.4 |
...
| NIST-800-88 | Media Sanitisation | Rev 1 | 5.6 |
