---
title: "Example: Medwick Healthcare Trust -- MyMedwick Patient Portal"
description: "A completed SAD for an NHS Trust patient portal on Microsoft Azure, demonstrating ADS at Comprehensive depth for a Tier 1 Critical clinical system."
---
...
<img src="/v1/logos/medwick-healthcare.svg" alt="Medwick Healthcare Trust logo (fictional)" class="example-org-logo" />
...
| Question | Response |
|----------|----------|
| Hosting region chosen for low carbon intensity | Azure UK South (London) primary and UK West (Cardiff) DR — chosen for data residency and NHS DSPT requirements. Microsoft has committed to 100% renewable energy matching across UK regions by 2025. UK West's published grid mix is on average cleaner than UK South. |
...
| Question | Response |
|----------|----------|
| Retention periods minimised to regulator + business need | Yes — patient identifiable data retained per Records Management Code of Practice for Health and Social Care 2021 (ranges 8 years for adult outpatient records to lifetime+8 for some categories); audit logs 25 years (NHS DSPT requirement); session data ≤ 24 hours. ADLS Gen2 lifecycle policies enforce automatic expiry; no "indefinite" retention. |
...
| Carbon footprint reported alongside cost | Yes — Azure Emissions Impact Dashboard reviewed monthly alongside cost; reported quarterly to Trust Sustainability Committee against the NHS Net Zero target (2040). |
