...
*[Diagram would show the monthly payroll data flow: Employee data entry -> PayrollPro -> Payroll calculation engine -> Payment file (BACS), Pension submission (Crestfield API), HMRC RTI submission (HMRC API), Payslip PDFs (Blob Storage), Finance journal (ADF -> SAP)]*
