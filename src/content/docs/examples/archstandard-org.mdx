...
<img src="/v1/ads-logo-256.png" alt="ADS logo" class="example-org-logo" />
...
<Mermaid alt="Build pipeline: MDX content, JSON Schema, and Template Generator feed into Astro SSG, producing static HTML served by Cloudflare Pages CDN to end users." chart={`graph TD
