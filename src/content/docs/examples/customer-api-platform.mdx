...
| Batch processes consolidated rather than continuously polling | Yes -- transaction enrichment runs as nightly batch (00:30 UTC) rather than per-event; Featurespace ARIC fraud signals consumed via webhook (push) rather than polling |
