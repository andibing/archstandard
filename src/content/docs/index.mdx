...
<Aside type="tip" title="Three names you'll see throughout">
**ADS** is *this standard*. **SAD** (Solution Architecture Document) is the document you produce by following it. **HLD** (High Level Design) is the architectural-views-and-quality-attributes content that lives inside a SAD. So: ADS = the rules, SAD = the artefact, HLD = the design content. [More terminology](/v1/standard/how-to-use/#acronyms-used-throughout-the-standard).
</Aside>
...
**ADS v1.3.3** | Author: **[Andi Chandler](https://andi.me/)** | Published by: **ArchStandard** | Licence: **[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)** | [Contribute on GitHub](https://github.com/andibing/archstandard)
</Aside>
