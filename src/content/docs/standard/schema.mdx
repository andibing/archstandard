...
├── decisionMaking         Section 6: constraints, risks, decisions, compliance
...
| `decisionMakingGovernance.risks` | 6. Decision Making & Governance |
...
```bash
# Using ajv-cli
npx ajv validate -s schema/ads.schema.json -d my-hld.json

# Using Python jsonschema
python -m jsonschema -i my-hld.json schema/ads.schema.json
```
