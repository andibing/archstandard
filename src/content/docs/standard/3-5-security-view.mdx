...
Map the solution against applicable security standards and frameworks. Record formal compliance requirements in the [CRAIDS Log](/v1/standard/6-decision-making/#61-craids-log) (Standards category).

| Standard / Framework | Applicability | Notes |
|---|---|---|
| **ISO/IEC 27001** | Yes / No / Partial | *[which controls are in scope; certification required?]* |
| **NIST CSF 2.0** | Yes / No / Partial | *[Govern / Identify / Protect / Detect / Respond / Recover]* |
| **Cyber Essentials (UK)** | Yes / No / Partial | *[Basic or Plus; certification status]* |
| **SOC 2 Type II** | Yes / No / Partial | *[trust service criteria in scope — Security, Availability, etc.]* |
| **PCI-DSS** | Yes / No / N/A | *[if payment card data is in scope]* |
