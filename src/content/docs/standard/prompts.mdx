...
A collection of prompts and skills for using Large Language Models (ChatGPT, Claude, Copilot, Gemini) alongside the ADS standard.
...
A persistent skill for [Claude Code](https://claude.ai/code) that gives your AI assistant full ADS knowledge whenever it is working in your project. Unlike the one-shot prompts below, this skill is always available — no copy-pasting required.

**[Download ads-skill.md](/v1/prompts/ads-skill.md)**

**To install:** copy `ads-skill.md` into `.claude/agents/` at the root of your project repository.

Once installed, Claude Code can find and read your SAD, generate new sections from a brief, review completeness against the standard, validate depth tiers, and maintain the CRAIDS log — all without you needing to explain what ADS is each time.
...
**[Download first-draft.md](/v1/prompts/first-draft.md)**
...
**[Download validate-sad.md](/v1/prompts/validate-sad.md)**
...
**[Download score-sad.md](/v1/prompts/score-sad.md)**
...
**[Download security-review.md](/v1/prompts/security-review.md)**
...
**[Download governance-review.md](/v1/prompts/governance-review.md)**
...
**[Download improve-sad.md](/v1/prompts/improve-sad.md)**
...
3. Attach or paste your SAD. Optionally attach the [JSON Schema](/schema/v1.0.0/ads.schema.json) for stricter checking.
