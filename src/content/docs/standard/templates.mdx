...
Download a blank SAD template from the **[Downloads](/standard/downloads/)** page in your preferred format (Word, Markdown, YAML, or JSON).
...
See the [JSON Schema](/standard/schema/) page for more validation options.
...
See [Conformance and Usage](/standard/how-to-use/) for full customisation guidelines.
