...
Once you've completed your SAD in JSON or YAML, validate it against the ADS schema. See **[Validating a SAD against the Schema](/v1/standard/schema/#validating-a-sad-against-the-schema)** on the JSON Schema page for the full Node and Python instructions.
