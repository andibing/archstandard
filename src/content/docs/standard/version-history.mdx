...
This table shows which JSON Schema version each release of the standard supports. SADs and any third-party builders ([see specification](https://github.com/andibing/archstandard/blob/main/docs/sad-builder-spec.md)) should target the schema version listed here.

| Standard Version | JSON Schema Version | Schema URL | Notes |
|------------------|---------------------|------------|-------|
| v1.0.0 | v1.0.0 | [`/schema/v1.0.0/ads.schema.json`](https://archstandard.org/schema/v1.0.0/ads.schema.json) | Initial release; schema established |
| v1.1.0 | v1.0.0 | [`/schema/v1.0.0/ads.schema.json`](https://archstandard.org/schema/v1.0.0/ads.schema.json) | Content additions only; schema unchanged |
| v1.2.0 | v1.0.0 | [`/schema/v1.0.0/ads.schema.json`](https://archstandard.org/schema/v1.0.0/ads.schema.json) | Public release; schema unchanged |
| v1.3.0 | v1.0.0 | [`/schema/v1.0.0/ads.schema.json`](https://archstandard.org/schema/v1.0.0/ads.schema.json) | Adoption release; schema unchanged |

**Compatibility implication:** any SAD that validates against schema v1.0.0 is structurally valid against any v1.x.y release of the standard. Editorial improvements (new prompts, new guidance, new examples) do not invalidate prior SADs. A schema v2.0.0 would only ship alongside a standard v2.0.0 major release.
...
| **v1** | [archstandard.org/v1/](https://archstandard.org/v1/) | Current (v1.3.0, schema v1.0.0) |
