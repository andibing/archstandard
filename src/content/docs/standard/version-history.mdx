...
|------------------|-------------|-----|--------|-------|
| **v1.0.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.1 | Initial release; schema established |
| **v1.1.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.1 | Content additions; schema unchanged |
| **v1.2.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.1 | Public release; schema unchanged |
| **v1.3.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.1 | Adoption release; schema unchanged |
| **v1.3.1** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | **Current** | Bug fixes and SAD template polish; schema unchanged |
