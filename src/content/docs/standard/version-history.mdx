...
|------------------|-------------|-----|--------|-------|
| **v1.0.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.2 | Initial release; schema established |
| **v1.1.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.2 | Content additions; schema unchanged |
| **v1.2.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.2 | Public release; schema unchanged |
| **v1.3.0** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.2 | Adoption release; schema unchanged |
| **v1.3.1** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | Superseded by v1.3.2 | Bug fixes and SAD template polish; schema unchanged |
| **v1.3.2** | [v1.0.0](https://archstandard.org/schema/v1.0.0/ads.schema.json) | [archstandard.org/v1/](https://archstandard.org/v1/) | **Current** | Schema consistency fixes and section 6.6/6.8/6.10 additions; schema unchanged |
