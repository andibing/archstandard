...
The standard is **extensible** — organisations can add custom sections, map to internal tools and standards, and define governance gates without modifying the core structure. See [Organisation Customisation](/v1/standard/how-to-use/#organisation-customisation) for details.
