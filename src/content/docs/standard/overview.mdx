...
2. **Governance** — Enables an architecture review board (ARB) or design authority to evaluate the design against quality criteria
...
| **Architecture Review Board (ARB) / Design Authority** | All sections — as a review and governance framework |
