...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ┌─── TIER 1: Architectural Views ────────────────────────┐     │
│  │                                                        │     │
│  │  3.1 Logical ──── 3.2 Integration ──── 3.3 Physical   │     │
│  │       │                  │                    │        │     │
│  │  3.4 Data ─────── 3.5 Security ─────── 3.6 Scenarios  │     │
│  │                                                        │     │
│  └────────────────────────────────────────────────────────┘     │
│                          │                                      │
│                    evaluated by                                  │
...
│  │                                                        │     │
│  │  4.1 Ops        4.2 Reliability    4.3 Performance     │     │
│  │  Excellence                                            │     │
│  │  4.4 Cost       4.5 Sustainability                     │     │
│  │                                                        │     │
│  └────────────────────────────────────────────────────────┘     │
│                          │                                      │
│                    supported by                                  │
...
│  │                                                        │     │
│  │  5. Lifecycle ──── 6. Decision Making ──── 7. Appendix │     │
│  │  Management        & Governance            (Glossary,  │     │
│  │  (Build, Deploy,   (RAID, ADRs,            References, │     │
│  │   Operate, Retire)  Compliance)             Scoring)   │     │
│  │                                                        │     │
│  └────────────────────────────────────────────────────────┘     │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
