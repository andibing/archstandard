...
- **[Quickstart](/standard/quickstart/)** — create your first SAD in minutes
- **[Depth Cheat Sheet](/standard/cheat-sheet/)** — see exactly what to fill in at each depth
- **[Download a template](/standard/downloads/)** — Word, Markdown, YAML, or JSON
- **[See completed examples](/examples/)** — four worked examples across different project types
