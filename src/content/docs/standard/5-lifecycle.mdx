...
| 5.3 Test & Release | Testing strategy and release management | <span class="maturity-indicator maturity-recommended">Recommended</span> |
| 5.4 Operations | Support model, service start, and maintainability | <span class="maturity-indicator maturity-recommended">Recommended</span> |
| 5.5 Resourcing & Skills | Team capability and readiness | <span class="maturity-indicator maturity-recommended">Recommended</span> |
| 5.6 Decommissioning & Exit | End-of-life, disposal, and vendor exit strategy | <span class="maturity-indicator maturity-recommended">Recommended</span> |
...
Technical debt is tracked in [Section 6.2 — Technical Debt Register](/v1/standard/6-decision-making/#62-technical-debt-register).
