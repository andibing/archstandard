...
Where this solution replaces or modifies existing systems, document the plan for removing legacy infrastructure and retiring technical debt.
...
Document any technical debt introduced or inherited by this solution:
