...
description: "Core design principles underpinning ADS-001, including atomic field design and multi-format compatibility."
---
...
ADS-001 is designed with **atomic fields** — structured, discrete values rather than free-text wherever possible. This is a core principle of the standard.
...
| **Governance-ready** | An ARB or design authority can verify completeness programmatically |
...
### Atomic Field Categories in ADS-001
...
ADS-001 is designed to work equally well as:
