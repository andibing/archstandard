...
| **Consistent terminology** | The [glossary](/standard/7-appendices/#71-glossary) defines all acronyms. Terms are used consistently throughout. |
...
All acronyms used in ADS are defined in the [glossary](/standard/7-appendices/#71-glossary). When completing a SAD:
