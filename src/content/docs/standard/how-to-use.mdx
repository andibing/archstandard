...
**Step 3 — Describe the architecture** (Section 3). Work through each architectural view. Start with the Logical View (what the solution does), then Physical View (where it runs), then fill in the remaining views.
...
**Step 6 — Capture decisions and risks** (Section 6). Complete the RAID log and record key architecture decisions.

**Step 7 — Score and submit** (Sections 7 + 2.6). Complete the compliance scoring table, add glossary/references, and submit for governance review.
