...
description: RAID log, architectural decisions, guardrail exceptions, and compliance traceability.
---
...
The RAID log (Constraints, Assumptions, Risks, Dependencies, Issues) provides a structured approach to capturing and managing all factors that could affect the design. Each item should be tracked through to resolution with clear ownership and evidence.
...
| ID | Risk Event | Category | Severity | Likelihood | Mitigation Strategy | Residual Risk | Owner | Last Assessed |
|----|-----------|----------|----------|-----------|-------------------|--------------|-------|---------------|
| R-001 | *[describe the risk]* | Technical / Security / Operational / Delivery / Commercial / Compliance | High / Medium / Low | High / Medium / Low | *[mitigation plan]* | High / Medium / Low | *[person]* | *[date]* |
