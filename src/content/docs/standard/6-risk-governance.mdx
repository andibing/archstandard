...
The CARDI framework (Constraints, Assumptions, Risks, Dependencies, Issues) provides a structured approach to capturing and managing all factors that could affect the design. Each item should be tracked through to resolution with clear ownership and evidence.
