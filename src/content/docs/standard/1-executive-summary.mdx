...
|------|-------------|------------------|
| **Tier 1: Critical** | Service failure causes immediate, severe business impact | <span class="maturity-indicator maturity-comprehensive">Comprehensive</span> |
| **Tier 2: High Impact** | Service failure significantly impacts business operations | <span class="maturity-indicator maturity-comprehensive">Comprehensive</span> |
| **Tier 3: Medium Impact** | Service failure impacts operations but workarounds exist | <span class="maturity-indicator maturity-recommended">Recommended</span> |
| **Tier 4: Low Impact** | Service failure has limited business impact | <span class="maturity-indicator maturity-recommended">Recommended</span> |
| **Tier 5: Minimal** | Service failure has negligible impact | <span class="maturity-indicator maturity-minimum">Minimum</span> |

Selected criticality: *[...]*

This classification drives requirements for resilience, recovery time objectives, and governance rigour throughout the design. See the [Depth Cheat Sheet](/v1/standard/cheat-sheet/) for what to fill in at each level.
