...
|-----------|--------------------------|---------|------------------------------|
| Identity & Access | *[e.g., Entra ID, Okta, CIS2]* | Yes / No | *[...]* |
| Messaging / Notifications | *[e.g., GOV.Notify, SES, SendGrid]* | Yes / No | *[...]* |
| API Management | *[e.g., Apigee, AWS API Gateway, Kong]* | Yes / No | *[...]* |
| Monitoring & Logging | *[e.g., Splunk, Datadog, Grafana]* | Yes / No | *[...]* |
| Data & Analytics | *[e.g., Snowflake, Databricks, FDP]* | Yes / No | *[...]* |
