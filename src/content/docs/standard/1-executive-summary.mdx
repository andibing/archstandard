...
This classification drives requirements for resilience, recovery time objectives, and governance rigour throughout the design. See the [Depth Cheat Sheet](/standard/cheat-sheet/) for what to fill in at each level.
