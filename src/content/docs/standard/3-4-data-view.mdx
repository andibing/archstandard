...
Identify the data protection laws and regulations that apply to this solution. Record formal compliance requirements in the [CRAIDS Log](/v1/standard/6-decision-making/#61-craids-log) (Standards category).

| Legislation | Applicable | Key Obligations |
|---|---|---|
| **UK GDPR / Data Protection Act 2018** | Yes / No | *[lawful basis for processing, data subject rights, DPO requirement, breach notification]* |
| **EU GDPR** | Yes / No | *[if processing personal data of EU residents]* |
| **US CCPA / CPRA** | Yes / No | *[if processing California residents' personal data]* |
| *[other — e.g. PIPEDA, PDPA, HIPAA]* | Yes / No | *[...]* |
