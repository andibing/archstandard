...
- **Data protection** — GDPR, UK Data Protection Act, CCPA
- **Financial services** — PCI-DSS, SOX, FCA rules, PSD2
- **Healthcare** — NHS DSPT, HIPAA, HL7/FHIR standards
- **Security** — ISO 27001, NIST CSF, Cyber Essentials, SOC 2
