...
This section provides a governance summary index. The full Architecture Decision Records with context, alternatives, and consequences are documented in [Section 3.6.2 — Scenarios](/standard/3-6-scenarios/#362-architecture-decision-records-adrs).
</div>
