---
title: "3.2 Process View"
description: Data flows, integration architecture, and API/interface contracts.
---

<span class="maturity-indicator maturity-minimum">Minimum</span>
<span class="framework-badge badge-4plus1">4+1 Process</span>

## Purpose

The Process View describes the runtime behaviour of the solution - how data flows through the system, how components communicate, and how the solution integrates with internal and external systems. It addresses the concerns of integrators, operations teams, and architects.
