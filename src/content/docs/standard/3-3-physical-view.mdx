...
description: Deployment architecture, hosting, compute, networking, and environments.
---
...
The Physical View describes the infrastructure that hosts and supports the solution - servers, containers, networks, cloud services, and deployment environments. It addresses the concerns of infrastructure engineers, DevOps teams, and platform engineers.
