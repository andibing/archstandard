...
| **3** | Hosting location considered for carbon impact, non-production auto-shutdown enabled, resources right-sized |
| **5** | All of the above plus workload patterns optimised, continuous availability justified where required, carbon metrics baselined |
</div>
