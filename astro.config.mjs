			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: '3.2 Integration & Data Flow', slug: 'standard/3-2-integration-view', translations: { fr: '3.2 Intégration et flux de données', de: '3.2 Integration und Datenfluss' } },
